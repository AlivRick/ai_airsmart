#!/usr/bin/env python3
"""
PDF Chatbot sử dụng LangChain, FAISS và Google Gemini
...
class GeminiPDFChatbot:
    """
    Lớp PDFChatbot sử dụng Google Gemini để xử lý file PDF và trả lời câu hỏi
    """
    ...
    def ask_question(self, question: str) -> dict:
        ...
        try:
            ...
            prompt = f"""
            Dựa trên thông tin sau đây từ tài liệu PDF, hãy trả lời câu hỏi bằng tiếng Việt.
            Nếu thông tin không đủ để trả lời, hãy nói rằng bạn không tìm thấy thông tin cần thiết.
